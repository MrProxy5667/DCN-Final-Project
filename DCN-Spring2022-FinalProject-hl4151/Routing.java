/**
* Routing.java
* This file defines the routing manager used in ShortestPathSwitching.
* Main class Routing can generate network topology using input links, and then
* generate shortest paths using Dijkstra's Algorithm.
* It also provides methods to return or print shortest paths;
* 
